# Exploratory Story: Ariad Operational Observatory
...
Como cada campo da homepage Ariad deve se abrir em uma visualização própria sem virar editor ou backlog coercitivo?
