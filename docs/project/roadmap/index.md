...
| [CV-003.DS-002](cv-003-nautilus-method-integration/ds-002-operational-journey-artifacts/index.md) | Operational Journey Artifacts | Artifacts presents a bounded Journey documentation tree with a safe content, details and metadata viewer | 🟠 In Progress |
