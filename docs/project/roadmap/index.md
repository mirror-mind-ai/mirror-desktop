...
| [CV-008.DS-004](cv-008-conversation-spaces/ds-004-multiple-conversations-per-journey/index.md) | Multiple Conversations per Journey | Navigator can browse a unified Journey catalog, create or resume exact Desktop Conversations, organize Mirror history or continue it through an explicit agent handoff, and keep long Desktop history bounded through compaction-aligned Segments without a Mirror core update | 🟡 Planned |
