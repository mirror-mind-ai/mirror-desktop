...
The codes identify the five accepted product demands. Current approved sequence after DS-002 is DS-004, then DS-003, then DS-005 so the shared conversation substrate precedes persona destinations.
...
| [CV-008.DS-004](cv-008-conversation-spaces/ds-004-multiple-conversations-per-journey/index.md) | Multiple Conversations per Journey | Navigator keeps the existing Journey-level workspace, explicitly focuses one Journey to browse additional Conversations, and can organize Mirror history or continue it through an agent handoff without a Mirror core update | 🟡 Planned |
