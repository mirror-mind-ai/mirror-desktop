...
| [CV-008.DS-004](cv-008-conversation-spaces/ds-004-multiple-conversations-per-journey/index.md) | Multiple Conversations per Journey | Navigator can browse a unified Journey conversation catalog, create or resume exact Desktop conversations, continue Mirror history through an explicit working copy and keep long history bounded through compaction-aligned technical segments | 🟡 Planned |
