...
| [DS-010.US-1](ds-010-us-1-create-journey/index.md) | Create Journey | User Story | Create a canonical root from the Tree control menu or append a child from an item context menu with its parent preselected, using name, slug, description and optional project path | 🟡 Planned |
