...
| CV-002.DS-004.US-5 | Reconcile Mirror-Only Updates into Pi | User Story | Mirror-only advances are detected automatically and applied to Pi only through explicit safe reconciliation | 🟠 In Planning |
