...
|------:|----|----|--------|--------|--------|----------|
| 1 | [CR076](rs016-ongoing-product-improvements-and-adjustments/cr076-surface-the-thinking-process-of-every-model.md) | RS016 | Surface the Thinking Process of Every Model | in_progress | @alissonvale | `refinement/rs016-cr076-model-agnostic-reasoning` |
