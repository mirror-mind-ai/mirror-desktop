...
- Change Request: CR050 — Accept Failed Native Leaves as Interrupted-Attempt Evidence
...
|------:|----|----|--------|--------|--------|----------|
| 1 | [CR050](rs018-terminal-aligned-conversation-continuity/cr050-accept-failed-native-leaves-as-interrupted-attempt-evidence.md) | RS018 | Accept Failed Native Leaves as Interrupted-Attempt Evidence | in_progress | @alissonvale | `refinement/rs018-cr050-failed-native-leaf-evidence` |
