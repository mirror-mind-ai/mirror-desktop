...
|------:|----|----|--------|--------|--------|----------|
| 1 | [CR058](rs019-post-terminal-continuity/cr058-remove-post-terminal-journal-state-from-conversation-admission.md) | RS019 | Remove Post-Terminal Journal State from Conversation Admission | in_progress | @alissonvale | `refinement/rs019-cr058-journal-admission-release` |
