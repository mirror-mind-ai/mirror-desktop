...
- Change Request: CR045 — Make Pre-Agent Staging Non-Authoritative
...
|------:|----|----|--------|--------|--------|----------|
| 1 | [CR045](rs018-terminal-aligned-conversation-continuity/cr045-make-pre-agent-staging-non-authoritative.md) | RS018 | Make Pre-Agent Staging Non-Authoritative | in_progress | @alissonvale | `refinement/rs018-cr045-pre-agent-staging-atomicity` |
