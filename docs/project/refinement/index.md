...
| 4 | [CR021](rs011-conversation-surface-semantic-composition/cr021-compose-agent-turns-into-semantic-groups.md) | RS011 | Compose agent turns into semantic groups | in_progress | @alissonvale | `refinement/rs011-cr021-semantic-turn-composition` |
