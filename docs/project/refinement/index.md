...
|------:|----|----|--------|--------|--------|----------|
| 1 | [CR034](rs017-reliable-agent-access/cr034-replace-generic-retry-with-explicit-recovery-routes.md) | RS017 | Replace Generic Retry with Explicit Recovery Routes | in_progress | @alissonvale | `refinement/rs017-cr034-explicit-recovery-routes` |
