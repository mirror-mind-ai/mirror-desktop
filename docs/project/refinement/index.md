...
| 11 | [RS011](rs011-conversation-surface-semantic-composition/index.md) | Conversation surface semantic composition | active |
...
| 4 | [CR021](rs011-conversation-surface-semantic-composition/cr021-compose-agent-turns-into-semantic-groups.md) | RS011 | Compose agent turns into semantic groups | captured | — | — |
...
| 7 | [CR024](rs011-conversation-surface-semantic-composition/cr024-prevent-agent-output-flicker-when-turn-settles.md) | RS011 | Prevent agent output flicker when a turn settles | in_progress | @alissonvale | `refinement/rs011-cr024-output-settlement-flicker` |
