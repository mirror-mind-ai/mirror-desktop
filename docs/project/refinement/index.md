...
|------:|----|----|--------|--------|--------|----------|
| 1 | [CR060](rs019-post-terminal-continuity/cr060-rehearse-non-blocking-post-terminal-continuity.md) | RS019 | Rehearse Non-Blocking Post-Terminal Continuity | validated | @alissonvale | `refinement/rs019-cr060-post-terminal-rehearsal` |
