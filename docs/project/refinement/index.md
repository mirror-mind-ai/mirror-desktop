...
- Refinement Story: RS014 — Transient Composer Notices
- Change Request: CR027 — Auto-dismiss transient composer notices
...
| 14 | [RS014](rs014-transient-composer-notices/index.md) | Transient Composer Notices | active |
...
|------:|----|----|--------|--------|--------|----------|
| 1 | [CR027](rs014-transient-composer-notices/cr027-auto-dismiss-transient-composer-notices.md) | RS014 | Auto-dismiss transient composer notices | in_progress | @alissonvale | `refinement/rs014-cr027-transient-composer-notices` |
