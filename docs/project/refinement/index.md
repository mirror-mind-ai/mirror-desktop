...
|------:|----|----|--------|--------|--------|----------|
| 1 | [CR063](rs016-ongoing-product-improvements-and-adjustments/cr063-align-sync-recovery-notice-with-presented-conversation.md) | RS016 | Align Synchronization Recovery Notice with the Presented Conversation | in_progress | @alissonvale | `refinement/rs016-cr063-align-sync-notice-projection` |
