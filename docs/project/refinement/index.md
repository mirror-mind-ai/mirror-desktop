...
|------:|----|----|--------|--------|--------|----------|
| 1 | [CR027](rs014-transient-composer-notices/cr027-auto-dismiss-transient-composer-notices.md) | RS014 | Auto-dismiss transient composer notices | validated | @alissonvale | `refinement/rs014-cr027-transient-composer-notices` |
