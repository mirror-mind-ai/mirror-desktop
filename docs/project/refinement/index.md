...
| 7 | [CR024](rs011-conversation-surface-semantic-composition/cr024-prevent-agent-output-flicker-when-turn-settles.md) | RS011 | Prevent agent output flicker when a turn settles | validated | @alissonvale | `refinement/rs011-cr024-output-settlement-flicker` |
