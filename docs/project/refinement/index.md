...
|------:|----|----|--------|--------|--------|----------|
| 1 | [CR049](rs018-terminal-aligned-conversation-continuity/cr049-complete-the-release-shaped-rs018-acceptance-route.md) | RS018 | Complete the Release-Shaped RS018 Acceptance Route | planned | — | — |
