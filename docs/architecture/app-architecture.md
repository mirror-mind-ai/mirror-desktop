...
Development validation happens in **Nautilus Harness Dev** only. US-2 proved natural two-Journey overlap, Journey switching, owner-correct completion, bounded shutdown/restart and rollback compatibility. US-3 adds deterministic automated coverage for selective cancellation, first-terminal precedence, sibling isolation, controlled settlement failure and independent recovery; real DEV cancellation, exact-child process death and shutdown/restart signalling remain Validation work. Stable promotion remains outside DS-009 until separately authorized.
