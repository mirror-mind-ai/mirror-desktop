...
CV-008.DS-002 extends that proven contract to exactly four admitted Journey leases. Aggregate occupancy is visible while nonzero, finalizing leases continue to consume admission until exact cleanup and fresh reinspection, and a fifth Journey is refused immediately without process, turn, message or queue creation. Steering continues through the owning process and consumes no additional slot. Growth above four requires separately governed product need and new resource and authority evidence.
